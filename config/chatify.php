...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'MessagesTEC'),
    ...
    */
    'attachments' => [
        ...
        'allowed_images' => (array) ['png','jpg','jpeg','gif','web','svg'],
        'allowed_files' => (array) ['zip','rar','txt','docx','pdf','xlsx','pptx','mp4','sql','ogg','py','php','html','css','js'],
        'max_upload_size' => env('CHATIFY_MAX_FILE_SIZE', 1024), // MB
    ],
